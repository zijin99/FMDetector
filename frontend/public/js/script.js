...
let step = 1;
let feeding_option = 1;

$(".feeding-steps").hide();
$("#feeding-step-"+step).show();

$("#feeding-option-1").click(() => {
  feeding_option = 1;
});

$("#feeding-option-2").click(() => {
  feeding_option = 2;
});
...
$("#step-next").click(() => {
  ...
  if(step === 2){
    ...
    if($('input[name="feedingOption"]:checked').val() === "1"){
      $("#feeding-step-"+step+"-1").show();
    }else{
      $("#feeding-step-"+step+"-2").show();
    }
...
$("#step-prev").click(() => {
  ...
  $("#feeding-step-"+step).show();
  if(step === 2){
    if($('input[name="feedingOption"]:checked').val() === "2"){
      $("#feeding-step-"+step+"-1").show();
    }else{
      $("#feeding-step-"+step+"-2").show();
    }
